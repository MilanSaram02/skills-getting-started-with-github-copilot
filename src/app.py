...
activities = {
    ...
    "Swimming Club": {
        "description": "Develop swimming techniques and endurance",
    ...
    "Drama Club": {
        "description": "Perform plays and develop acting and stagecraft skills",
